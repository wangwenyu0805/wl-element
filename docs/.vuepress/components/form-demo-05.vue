    ...
    >
      <template v-slot:date="{form,item}">
        <el-form-item label="活动时间">
          ...
          <el-col :span="11">
            <wl-date v-model="form.date2" prop="date2" style="width: 100%;"></wl-date>
          </el-col>
        </el-form-item>
      </template>
    </wl-form>
...
export default {
  ...
  computed: {
    formItems () {
      return [
        { comp: 'wl-input', label: '规则名称', prop: 'name' },
        { comp: 'wl-input', label: '描述', prop: 'desc' },
        { comp: 'wl-input', label: '调用服务次数', prop: 'times' },
        { comp: 'wl-input', label: '调用服务次数', prop: 'times' },
        { comp: 'wl-input', label: '调用服务次数', prop: 'times' },
        { comp: 'wl-input', label: '调用服务次数', prop: 'times' },
        { comp: 'wl-input', label: '调用服务次数', prop: 'times' },
        { comp: 'wl-date', label: '上次调度时间', prop: 'lastUseTime' }
      ]
    },
    regionOptions () {
      return [
